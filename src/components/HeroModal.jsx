    ...
    <>
      ...
      <div className="cards-2col">
        <div className="sheet-card">
          ...
          <p className="skill-note">For anything not listed, use the matching ability modifier.</p>
        </div>
          ...
          <div className="sheet-card">
            ...
            <div className="spell-group">
              ...
              <div className="spell-chips">
                {hero.spell.cantrips.map(c => <span key={c} className="spell-chip">{c}</span>)}
              </div>
            </div>
            <div className="spell-group">
              <div className="gl">{hero.spell.label}</div>
              <div className="spell-chips">
                {hero.spell.known.map(c => <span key={c} className="spell-chip">{c}</span>)}
              </div>
            </div>
          </div>
        )}
    ...
    <>
      ...
      <div className="combat-stats">
        ...
        <div className="combat-stat">
          ...
          <div className="cs-lab">Proficiency Bonus</div>
        </div>
      </div>
      ...
      <div className="hp-block">
        ...
        <div className="hp-sub">Hit Dice: {hero.hitDice}</div>
        <div className="death-pips-section">
      ...
      <table className="skills-full-table">
        ...
        <tbody>
          {SKILL_LIST.map(sk => {
            ...
            return (
              <tr key={sk.name} className={isProf ? 'prof-row' : ''}>
                <td>
    ...
    <>
      ...
      <div className="details-grid">
        ...
        <div className="sheet-card">
          <h4>Bonds</h4>
          <div className="kit">
            <div className="row">Connected to the island and its people.</div>
          </div>
        </div>
        <div className="sheet-card">
          <h4>Flaws</h4>
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-sheet" onClick={e => e.stopPropagation()} role="dialog" aria-label={`${hero.name} character sheet`}>
        ...
        <div className="sheet-inner">
          {activeTab === 'main' && <TabMain hero={hero} />}
          {activeTab === 'combat' && <TabCombat hero={hero} />}
          {activeTab === 'skills' && <TabSkills hero={hero} />}
          {activeTab === 'details' && <TabDetails hero={hero} />}
        </div>
      </div>
    </div>
  );
